...
function move_player.moveplayer2(game, windowWidth, windowHeight, dt)
    if love.keyboard.isDown("o") and game.player2_y > 0 then
        game.player2_rotation = math.rad(180)
        game.player2_y = game.player2_y - game.player2_speed * dt
    end
    if love.keyboard.isDown("l") and game.player2_y < windowHeight - game.player2:getHeight() then
        game.player2_rotation = math.rad(360)
        game.player2_y = game.player2_y + game.player2_speed * dt
    end
    if love.keyboard.isDown("k") and game.player2_x > 0 then
        game.player2_rotation = math.rad(90)
        game.player2_x = game.player2_x - game.player2_speed * dt
    end
    if love.keyboard.isDown("m") and game.player2_x < windowWidth - game.player2:getWidth() then
        game.player2_rotation = math.rad(-90)
        game.player2_x = game.player2_x + game.player2_speed * dt
    end
end
